...
text_pip = Pipeline([('vect', CountVectorizer(stop_words=ENGLISH_STOP_WORDS, ngram_range=(1,1), tokenizer = token.tokenize)), ('tfidf', TfidfTransformer()), ('clf', RandomForestClassifier())])
